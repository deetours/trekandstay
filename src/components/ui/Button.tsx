...
interface ButtonProps extends HTMLMotionProps<'button'> {
  variant?: 'primary' | 'secondary' | 'adventure' | 'ghost';
  size?: 'sm' | 'md' | 'lg' | 'xl';
...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    secondary: 'bg-stone-gray text-forest-green hover:bg-stone-gray/80 focus:ring-stone-gray border border-forest-green/20',
    ...
    ghost: 'text-forest-green hover:bg-forest-green/10 focus:ring-forest-green',
  };
  ...
  return (
    ...
    >
      ...
      <span className="absolute inset-0 bg-white opacity-0 hover:opacity-20 transition-opacity duration-200 rounded-lg" />
